...
const menuIconMap = {
  ...
  // 菜单管理页需要把“配置值”和“预览图标”一一对应展示，
  // 所以工作流图标也在这里补一份，避免下拉能选但预览区域为空。
  ...
  // 菜单管理页需要把新补充的业务建模类图标即时预览出来，
  // 否则下拉里虽然能选，但右侧表单和表格预览看不到最终效果。
  'business-model': <PartitionOutlined />,
  'business-definition': <FileTextOutlined />,
  'business-object': <ContainerOutlined />,
  'business-rule': <AuditOutlined />,
  'business-form': <FormOutlined />,
  'business-scene': <ProjectOutlined />,
  'business-service': <ApiOutlined />,
