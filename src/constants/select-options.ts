...
export const MENU_ICON_OPTIONS: Array<{ label: string; value: string }> = [
  ...
  { label: '已办箱', value: 'done-box' },
  { label: '查询箱', value: 'search' },
  // 日志类图标单独固定 key，
  // 是为了让系统日志、登录日志、操作日志等菜单后续直接复用稳定标识，不需要再频繁补前端映射。
  { label: '日志中心', value: 'log-center' },
  { label: '系统日志', value: 'system-log' },
  { label: '登录日志', value: 'login-log' },
  { label: '操作日志', value: 'operation-log' },
  { label: '审计日志', value: 'audit-log' },
  { label: '安全日志', value: 'security-log' },
  { label: '异常日志', value: 'error-log' },
  { label: '访问日志', value: 'access-log' },
  { label: '任务日志', value: 'task-log' },
  { label: '消息日志', value: 'message-log' },
